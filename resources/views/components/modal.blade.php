...
<div id="{{ $id }}" data-modal class="fixed inset-0 z-40 hidden items-center justify-center bg-slate-900/40 p-4">
    <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-lg" role="dialog" aria-modal="true">
